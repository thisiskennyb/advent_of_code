...
#This takes the values from above and applies them to the proper dictionary values             
                ...
                box_stack_from = stack[from_column][-int(box_quantity_to_move):]
                stack[from_column] = stack[from_column][:-int(box_quantity_to_move)]
                stack[to_column].extend(box_stack_from)
...
# elements_to_move = list1[-num_elements_to_remove:]

# list1 = list1[:-num_elements_to_remove]
# list2.extend(elements_to_move)
